...
int main(int argc, char *argv[]) {
  ...
  Tpetra::ScopeGuard tpetraScope(&argc, &argv);
  {
    ...
    *out << ">> I. Create linear system A*x=b." << std::endl;
    ...
    // read_mtx_file("/home/v-yinuoliu/code/tvms/output_matrix_small_true.mtx", input_file_string);
    ...
    // cnpy::NpyArray arr = cnpy::npy_load("/home/v-yinuoliu/code/tvms/b_small_true.npy");  
    ...
    for (global_ordinal_type i = 0; i < arr.shape[0]; ++i) {  
      rhs->replaceGlobalValue(i, data[i]);
      x->replaceGlobalValue(i, 0.0);
    }
    ////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////
    ...
    *out << ">> III. Solve the linear system." << std::endl;
    ...
    // Solve the linear system.
    {
      ...
      // 定义数组的形状  
      std::vector<size_t> shape = {arr.shape[0]};  
        
      // 将数组保存为 .npy 文件  
      cnpy::npy_save("trilinos_res_small.npy", x_values.getRawPtr(), shape, "w");  
